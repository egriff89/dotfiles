...
*** Custom keybinds for Ghostel
Override default keybinds for pasting text into a Ghostel buffer
#+begin_src emacs-lisp
...
** Odin
 ...
 Doom now has an official ~:lang odin~ module. Keeping this here as a fallback.
#+begin_src emacs-lisp
